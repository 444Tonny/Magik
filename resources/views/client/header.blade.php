...
<body>
    <header>
        <div class="logo">
            <div class='logo_container' onclick="window.location.href=window.location.origin + '/FortniteShop/www.magiktienda.com/public/'">
        ...
        <div id='menu' class="menu">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content profile_info">
                    @CSRF
                    @if(session()->has('givenName'))
